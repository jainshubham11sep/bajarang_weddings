...
export default function InstagramEmbed({ postUrl }: Props) {
  ...
  useEffect(() => {
    ...
    if (!document.querySelector('script[src*="instagram.com/embed.js"]')) {
      ...
      // If script is already loaded, re-process embeds
        ...
        <div style={{ padding: '16px' }}>
          ...
          >
            <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', marginBottom: '12px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', flexGrow: 1 }}>
                <div style={{ backgroundColor: '#F4F4F4', borderRadius: '4px', height: '14px', width: '100px', marginBottom: '6px' }} />
                <div style={{ backgroundColor: '#F4F4F4', borderRadius: '4px', height: '14px', width: '60px' }} />
              </div>
            </div>
            <div style={{ paddingBottom: '19%', height: 0 }}>
              <div style={{
                backgroundColor: '#F4F4F4',
                height: '100%',
                width: '100%',
          ...
          <p style={{ margin: '8px 0 0 0', padding: '0 4px' }}>
            <a
              ...
              rel="noopener noreferrer"
            >
              A post shared by Bajranng Weddings
            </a>
          </p>
        </div>
      </blockquote>
